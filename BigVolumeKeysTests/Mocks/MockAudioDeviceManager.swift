...
class MockAudioDeviceManager: AudioDeviceManaging {
    ...
    var mockDeviceNames: [AudioDeviceID: String] = [:]
    var mockSubDeviceInfos: [AudioDeviceID: [SubDevice]] = [:]
    var mockCanSetVolume: [AudioDeviceID: Bool] = [:]
    ...
    func canSetVolume(deviceID: AudioDeviceID) -> Bool {
        return mockCanSetVolume[deviceID] ?? true
    }
    ...
    func getSubDeviceInfos(deviceID: AudioDeviceID) -> [SubDevice]? {
        return mockSubDeviceInfos[deviceID]
    }

    func getDeviceName(deviceID: AudioDeviceID) -> String? {
        return mockDeviceNames[deviceID]
    }
    ...
    func reset() {
        ...
        mockDeviceNames.removeAll()
        mockSubDeviceInfos.removeAll()
        mockCanSetVolume.removeAll()
    }
}
